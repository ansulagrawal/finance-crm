...
--
-- Baseline legacy schema (149 tables), structure only, no data. Generated
-- from a real schema export of `dev` (confirmed byte-for-byte structurally
-- identical to `prod` — see docs/COMPLETED.md's schema-diff task) via
-- `mysqldump --no-data`/phpMyAdmin export. This is the starting point every
-- other file in this directory (m1.sql, m2.sql, ...) assumes.
--
-- Run this ONCE against a brand-new, empty database — either through
-- `bun run migrate --init` (database/src/run-sql-migrations.ts) or by
-- pasting it directly into phpMyAdmin/any MySQL client. It does not
-- `CREATE DATABASE` or `USE` anything — select/create your target database
-- first, this only creates tables inside whatever database is already
-- selected.
--
-- If any statement in here fails partway through, there is no automatic
-- revert (unlike m1.sql/m2.sql/...) — this is a one-time bootstrap onto an
-- empty database, so the correct recovery is to drop the target database
-- and start over with a fresh one, not to unwind table-by-table.
...
CREATE TABLE `api_account_aggregator_logs` (
  ...
  `s3_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1=>uploaded'
...
CREATE TABLE `api_bank_account_verification_logs` (
  ...
  `bav_provider_id` tinyint(3) UNSIGNED NOT NULL COMMENT '1=>Surepass, 2=>Digitap, 3=>Signzy',
  ...
  `bav_http_code` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `api_callback_trackier`
--

CREATE TABLE `api_callback_trackier` (
  `act_id` bigint(20) UNSIGNED NOT NULL,
  `act_method_id` tinyint(3) UNSIGNED DEFAULT NULL,
  `act_response` text DEFAULT NULL,
  `act_api_status_id` mediumint(9) NOT NULL COMMENT '1=>Success,2=>Error,3=>Connection Error,4=>IT Error',
  `act_errors` varchar(500) DEFAULT NULL,
  `act_response_datetime` datetime DEFAULT NULL,
  `act_profile_id` bigint(20) UNSIGNED DEFAULT NULL,
  `act_appsflyer_id` varchar(100) DEFAULT NULL,
  `act_platform_name` varchar(50) DEFAULT NULL,
  `act_event_name` varchar(100) DEFAULT NULL,
  `act_utm_source` varchar(100) DEFAULT NULL,
  `act_utm_medium` varchar(100) DEFAULT NULL,
  `act_utm_campaign` varchar(100) DEFAULT NULL,
  `act_profile_utm_source` varchar(250) DEFAULT NULL,
  `act_profile_utm_medium` varchar(250) DEFAULT NULL,
  `act_profile_utm_campaign` varchar(250) DEFAULT NULL,
  `act_profile_update_flag` tinyint(3) UNSIGNED DEFAULT NULL,
  `act_active` tinyint(1) NOT NULL DEFAULT 1,
  `act_deleted` tinyint(1) NOT NULL DEFAULT 0,
  `act_af_prt` varchar(200) DEFAULT NULL,
  `act_af_siteid` varchar(255) DEFAULT NULL,
  `act_lead_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `api_disburse_logs` (
  ...
  `disburse_bank_id` mediumint(8) UNSIGNED DEFAULT NULL COMMENT '1=>ICICI, 10 => RBL',
...
CREATE TABLE `api_email_verification_logs` (
  ...
  `ev_http_code` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `api_poi_verification_logs` (
  ...
  `poi_veri_provider` tinyint(3) UNSIGNED NOT NULL COMMENT '1=>Surepass, 2=>DigiTap, 3=>Signzy',
  `poi_veri_method_id` tinyint(4) NOT NULL COMMENT '1=>PAN FETCH, 2 => Dual PAN FETCH',
  `poi_veri_lead_id` bigint(20) UNSIGNED NOT NULL,
  `poi_veri_request` text DEFAULT NULL,
  `poi_veri_response` text DEFAULT NULL,
  `poi_veri_dual_response` text DEFAULT NULL,
  ...
  `poi_http_code` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `api_threshold_logs`
--

CREATE TABLE `api_threshold_logs` (
  `id` int(11) NOT NULL,
  `credential_id` int(11) NOT NULL,
  `raw_data_response` text NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `api_trackier_push_events`
--

CREATE TABLE `api_trackier_push_events` (
  `atpe_id` bigint(20) UNSIGNED NOT NULL,
  `atpe_request` text DEFAULT NULL,
  `atpe_response` text DEFAULT NULL,
  `atpe_api_status_id` mediumint(8) UNSIGNED NOT NULL COMMENT '1=>Success,2=>Error,3=>Connection Error,4=>IT Error',
  `atpe_errors` varchar(500) DEFAULT NULL,
  `atpe_request_datetime` datetime DEFAULT NULL,
  `atpe_response_datetime` datetime DEFAULT NULL,
  `atpe_lead_id` bigint(20) UNSIGNED DEFAULT NULL,
  `atpe_profile_id` bigint(20) UNSIGNED DEFAULT NULL,
  `atpe_trackier_id` varchar(100) DEFAULT NULL,
  `atpe_app_id` varchar(100) DEFAULT NULL,
  `atpe_event_name` varchar(100) DEFAULT NULL,
  `atpe_data_source_id` int(10) UNSIGNED DEFAULT NULL,
  `atpe_utm_source` varchar(100) DEFAULT NULL,
  `atpe_utm_medium` varchar(100) DEFAULT NULL,
  `atpe_utm_campaign` varchar(100) DEFAULT NULL,
  `atpe_utm_term` varchar(100) DEFAULT NULL,
  `atpe_active` tinyint(1) NOT NULL DEFAULT 1,
  `atpe_deleted` tinyint(1) NOT NULL DEFAULT 0,
  `atpe_provider_id` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- --------------------------------------------------------

--
-- Table structure for table `api_uan_logs`
--

CREATE TABLE `api_uan_logs` (
  `api_id` bigint(20) NOT NULL,
  `api_provider` tinyint(3) UNSIGNED NOT NULL COMMENT '1=>Surepass, 2=>DigiTap, 3 => Signzy',
  `api_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1=>UAN FETCH',
  ...
  `api_http_code` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `api_whatsapp_logs`
--

CREATE TABLE `api_whatsapp_logs` (
  `msg_log_id` bigint(20) UNSIGNED NOT NULL,
  `msg_provider` tinyint(4) DEFAULT NULL COMMENT '1=> MSG91',
  `msg_type_id` mediumint(8) UNSIGNED NOT NULL COMMENT '0=>send_otp, 1=>loan_amount',
  `msg_lead_id` bigint(20) UNSIGNED DEFAULT NULL,
  `msg_template_id` varchar(20) DEFAULT NULL,
  `msg_api_request` text DEFAULT NULL,
  `msg_api_response` text DEFAULT NULL,
  `msg_api_status_id` mediumint(8) UNSIGNED DEFAULT NULL COMMENT '1=>Success,2=>Api Error,3=>Conn Error,4=>LW Error',
  `msg_api_http_code` varchar(3) NOT NULL,
  `msg_template_source` varchar(20) DEFAULT NULL,
  `msg_errors` varchar(500) DEFAULT NULL,
  `msg_user_id` int(10) UNSIGNED DEFAULT NULL,
  `msg_api_request_datetime` datetime NOT NULL,
  `msg_api_response_datetime` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `cif_customer` (
  ...
  `cif_credeau_approved_customer` tinyint(4) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `collection_20260718`
--

CREATE TABLE `collection_20260718` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `old_recovery_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `collection_20260722`
--

CREATE TABLE `collection_20260722` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `old_recovery_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Triggers `collection_bucket_wise_permission`
--
DELIMITER $$
...
CREATE TABLE `company_holiday` (
  ...
  `ch_created_datetime` datetime DEFAULT current_timestamp(),
...
CREATE TABLE `credit_analysis_memo` (
  ...
  `sanction_letter_recovery_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'sanction recovered file'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `credit_analysis_memo_20260618`
--

CREATE TABLE `credit_analysis_memo_20260618` (
  `cam_id` bigint(20) UNSIGNED NOT NULL,
  `company_id` mediumint(8) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` mediumint(8) UNSIGNED NOT NULL DEFAULT 1,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `customer_profile_20260718`
--

CREATE TABLE `customer_profile_20260718` (
  `cp_id` bigint(20) NOT NULL,
  `cp_lead_id` bigint(20) DEFAULT NULL,
  `cp_first_name` varchar(255) DEFAULT NULL,
  `cp_middle_name` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `docs_20260710_02_15`
--

CREATE TABLE `docs_20260710_02_15` (
  `docs_id` bigint(20) UNSIGNED NOT NULL,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `application_no` varchar(50) DEFAULT NULL,
  `company_id` mediumint(8) UNSIGNED DEFAULT 1,
...
CREATE TABLE `leads` (
  ...
  `user_type` enum('NEW','REPEAT','UNPAID-REPEAT') DEFAULT 'NEW',
...
--
-- Table structure for table `leads_20260623`
--

CREATE TABLE `leads_20260623` (
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` varchar(20) DEFAULT NULL,
  `company_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
...
--
-- Table structure for table `leads_20260625`
--

CREATE TABLE `leads_20260625` (
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` varchar(20) DEFAULT NULL,
  `company_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
...
--
-- Table structure for table `leads_20260630`
--

CREATE TABLE `leads_20260630` (
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` varchar(20) DEFAULT NULL,
  `company_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
...
--
-- Table structure for table `leads_20260710_04_40`
--

CREATE TABLE `leads_20260710_04_40` (
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` varchar(20) DEFAULT NULL,
  `company_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
...
--
-- Table structure for table `leads_20260818`
--

CREATE TABLE `leads_20260818` (
  `lead_id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` varchar(20) DEFAULT NULL,
  `company_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `product_id` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
...
CREATE TABLE `lead_customer` (
  ...
  `customer_dualpan_flag` tinyint(4) DEFAULT NULL,
  ...
  `aa_aadhaar_address_coordinates` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `lead_customer_202260718`
--

CREATE TABLE `lead_customer_202260718` (
  `customer_seq_id` bigint(20) UNSIGNED NOT NULL,
  `customer_lead_id` bigint(20) UNSIGNED NOT NULL,
  `first_name` varchar(100) DEFAULT NULL,
  `middle_name` varchar(100) DEFAULT NULL,
...
CREATE TABLE `loan` (
  ...
  `loan_enach_mandate_datetime` date DEFAULT NULL,
  `loan_enach_schedule_amount` int(11) DEFAULT NULL,
  `loan_enach_schedule_date` date DEFAULT NULL,
  `loan_enach_schedule_identifier` varchar(200) NOT NULL,
  `loan_enach_schedule_status` tinyint(4) DEFAULT NULL,
  `loan_noc_recovery_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'noc recovery status'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `loan_20260626`
--

CREATE TABLE `loan_20260626` (
  `loan_id` int(10) UNSIGNED NOT NULL,
  `company_id` mediumint(8) UNSIGNED DEFAULT 1,
  `product_id` mediumint(8) UNSIGNED DEFAULT 1,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `loan_20260718`
--

CREATE TABLE `loan_20260718` (
  `loan_id` int(10) UNSIGNED NOT NULL,
  `company_id` mediumint(8) UNSIGNED DEFAULT 1,
  `product_id` mediumint(8) UNSIGNED DEFAULT 1,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `loan_20260722`
--

CREATE TABLE `loan_20260722` (
  `loan_id` int(10) UNSIGNED NOT NULL,
  `company_id` mediumint(8) UNSIGNED DEFAULT 1,
  `product_id` mediumint(8) UNSIGNED DEFAULT 1,
  `lead_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `loan_collection_visit`
--

CREATE TABLE `loan_collection_visit` (
  `col_visit_id` bigint(20) UNSIGNED NOT NULL,
  `col_lead_id` bigint(20) UNSIGNED NOT NULL,
  `col_visit_address_type` tinyint(3) UNSIGNED NOT NULL COMMENT '1=>Residence,2=>Office',
  `col_visit_requested_by` int(10) UNSIGNED NOT NULL COMMENT 'Visit Requested User',
  `col_visit_requested_by_remarks` varchar(500) DEFAULT NULL,
  `col_visit_requested_datetime` datetime DEFAULT NULL COMMENT 'Visit Requested Date time',
  `col_visit_scm_id` int(10) UNSIGNED DEFAULT NULL COMMENT 'State Collection Manager ID',
  `col_visit_scm_remarks` varchar(500) DEFAULT NULL COMMENT 'Visit Allocated Remarks If any',
  `col_visit_allocated_to` int(10) UNSIGNED DEFAULT NULL COMMENT 'Visit Allocate User ID',
  `col_visit_allocate_on` datetime DEFAULT NULL COMMENT 'Visitor allocated date time',
  `col_visit_field_status_id` tinyint(3) UNSIGNED DEFAULT NULL COMMENT '1=>Pending,2=>VISIT-INPROCESS,3=>Cancel,4=>Hold,5=>Completed',
  `col_visit_field_schedule_datetime` datetime DEFAULT NULL,
  `col_visit_field_datetime` datetime DEFAULT NULL,
  `col_visit_field_remarks` varchar(500) DEFAULT NULL,
  `col_visit_created_on` datetime NOT NULL,
  `col_visit_updated_on` datetime DEFAULT NULL,
  `col_visit_active` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
  `col_visit_deleted` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `col_fe_visit_trip_status_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '1=> Start, 2=>Cancel, 3=>Stop, 4=>End',
  `col_fe_visit_trip_start_latitude` double DEFAULT NULL COMMENT 'fe => Field Executive',
  `col_fe_visit_trip_start_longitude` double DEFAULT NULL,
  `col_fe_visit_trip_start_datetime` datetime DEFAULT NULL,
  `col_fe_device_id` varchar(50) DEFAULT NULL COMMENT 'fe => Field Executive Device Id',
  `col_fe_visit_trip_stop_latitude` double DEFAULT NULL,
  `col_fe_visit_trip_stop_longitude` double DEFAULT NULL,
  `col_fe_visit_trip_stop_datetime` datetime DEFAULT NULL,
  `col_fe_visit_end_latitude` double DEFAULT NULL,
  `col_fe_visit_end_longitude` double DEFAULT NULL,
  `col_fe_visit_end_datetime` datetime DEFAULT NULL,
  `col_fe_visit_upload_selfie` varchar(255) DEFAULT NULL,
  `col_fe_visit_upload_location` varchar(255) DEFAULT NULL,
  `col_fe_visit_total_distance_covered` double DEFAULT NULL,
  `col_fe_visit_total_amount_received` double DEFAULT NULL,
  `col_fe_visit_payment_screenshot` varchar(255) DEFAULT NULL,
  `col_fe_rtoh_return_datetime` datetime DEFAULT NULL COMMENT 'rtoh=> return to office/home',
  `col_fe_rtoh_return_type` tinyint(4) DEFAULT NULL COMMENT '1=>Home, 2=>Office',
  `col_fe_rtoh_total_distance_covered` double UNSIGNED DEFAULT NULL,
  `col_fe_rtoh_remarks` varchar(500) DEFAULT NULL,
  `col_fe_rtoh_upload_selfie` varchar(255) DEFAULT NULL,
  `col_fe_rtoh_end_latitude` double DEFAULT NULL,
  `col_fe_rtoh_end_longitude` double DEFAULT NULL,
  `col_fe_visit_approval_status` tinyint(3) UNSIGNED DEFAULT NULL COMMENT 'Convence Approval\r\n1=>Approved, 2=>Rejected',
  `col_fe_visit_approval_user_id` int(10) UNSIGNED DEFAULT NULL,
  `col_fe_visit_approval_datetime` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `master_city_20260617`
--

CREATE TABLE `master_city_20260617` (
  `m_city_id` int(10) UNSIGNED NOT NULL,
  `m_city_name` varchar(150) NOT NULL,
  `m_city_code` varchar(20) DEFAULT NULL,
  `m_city_category` char(1) DEFAULT NULL,
...
CREATE TABLE `master_credentials` (
  ...
  `credentials_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
--
-- Table structure for table `master_pincode_20260617`
--

CREATE TABLE `master_pincode_20260617` (
  `m_pincode_id` int(10) UNSIGNED NOT NULL,
  `m_pincode_value` mediumint(8) UNSIGNED NOT NULL,
  `m_pincode_city_id` int(10) UNSIGNED NOT NULL,
  `m_pincode_active` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
...
--
-- Table structure for table `master_pincode_old`
--

CREATE TABLE `master_pincode_old` (
  `m_pincode_id` int(10) UNSIGNED NOT NULL,
  `m_pincode_value` mediumint(8) UNSIGNED NOT NULL,
  `m_pincode_city_id` int(10) UNSIGNED NOT NULL,
  `m_pincode_active` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
...
CREATE TABLE `master_providers` (
  ...
  `type` enum('OTP','EKYC','VKYC','PAN','UAN','DUALPAN','CIBIL','PENNYDROP','EMAIL','OTHER') DEFAULT 'OTP',
...
--
-- Table structure for table `master_state_20260617`
--

CREATE TABLE `master_state_20260617` (
  `m_state_id` mediumint(8) UNSIGNED NOT NULL,
  `m_state_name` varchar(150) NOT NULL,
  `m_state_code` varchar(20) DEFAULT NULL,
  `cibil_state_code` mediumint(8) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `user_roles` (
  ...
  `lead_allocation_type` tinyint(4) DEFAULT 0 COMMENT '0=>No Allocation Required,42=>Partial-Leads,1=>Lead-New,3=>Lead-Hold, 4=>Application-New,6=>Application-Hold'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
ALTER TABLE `api_account_aggregator_logs`
  ...
  ADD KEY `aa_method_id` (`aa_method_id`),
  ADD KEY `aa_doc_id` (`aa_doc_id`);
...
--
-- Indexes for table `api_callback_trackier`
--
ALTER TABLE `api_callback_trackier`
...
--
-- Indexes for table `api_threshold_logs`
--
ALTER TABLE `api_threshold_logs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `api_trackier_push_events`
--
ALTER TABLE `api_trackier_push_events`
  ADD PRIMARY KEY (`atpe_id`);

--
-- Indexes for table `api_uan_logs`
--
ALTER TABLE `api_uan_logs`
...
--
-- Indexes for table `api_whatsapp_logs`
--
ALTER TABLE `api_whatsapp_logs`
  ADD PRIMARY KEY (`msg_log_id`),
  ADD KEY `msg_lead_id` (`msg_lead_id`);
...
ALTER TABLE `collection`
  ...
  ADD KEY `received_amount` (`received_amount`);

--
-- Indexes for table `collection_20260718`
--
ALTER TABLE `collection_20260718`
  ADD PRIMARY KEY (`id`),
  ADD KEY `recovery_id` (`id`),
  ADD KEY `lead_id` (`lead_id`),
  ADD KEY `company_id` (`company_id`,`product_id`),
...
--
-- Indexes for table `collection_20260722`
--
ALTER TABLE `collection_20260722`
  ADD PRIMARY KEY (`id`),
  ADD KEY `recovery_id` (`id`),
  ADD KEY `lead_id` (`lead_id`),
  ADD KEY `company_id` (`company_id`,`product_id`),
...
ALTER TABLE `credit_analysis_memo`
  ...
  ADD KEY `cam_sanction_letter_file_name` (`cam_sanction_letter_file_name`);

--
-- Indexes for table `credit_analysis_memo_20260618`
--
ALTER TABLE `credit_analysis_memo_20260618`
  ADD PRIMARY KEY (`cam_id`),
  ADD KEY `company_id` (`company_id`),
  ADD KEY `product_id` (`product_id`),
  ADD KEY `lead_id` (`lead_id`),
...
ALTER TABLE `customer_otp`
  ...
  ADD KEY `otp_mobile` (`otp_mobile`),
  ADD KEY `otp` (`otp`),
  ADD KEY `otp_verified_at` (`otp_verified_at`),
  ADD KEY `otp_status` (`otp_status`),
  ADD KEY `otp_created_at` (`otp_created_at`),
  ADD KEY `otp_valid_till` (`otp_valid_till`);
...
ALTER TABLE `customer_profile`
  ...
  ADD KEY `cp_fcm_token` (`cp_fcm_token`),
  ADD KEY `cp_login_fcm_token` (`cp_login_fcm_token`),
  ADD KEY `cp_mobile_verified` (`cp_mobile_verified`),
  ADD KEY `cp_pancard_verified_status` (`cp_pancard_verified_status`),
  ADD KEY `cp_user_type` (`cp_user_type`),
  ADD KEY `cp_residence_city_id` (`cp_residence_city_id`),
  ADD KEY `cp_residence_state_id` (`cp_residence_state_id`),
  ADD KEY `cp_journey_type_id` (`cp_journey_type_id`),
  ADD KEY `cp_journey_stage` (`cp_journey_stage`),
  ADD KEY `cp_status_id` (`cp_status_id`),
  ADD KEY `cp_utm_source` (`cp_utm_source`),
  ADD KEY `cp_data_source_id` (`cp_data_source_id`),
  ADD KEY `cp_active` (`cp_active`,`cp_deleted`),
  ADD KEY `cp_created_at` (`cp_created_at`);

--
-- Indexes for table `customer_profile_20260718`
--
ALTER TABLE `customer_profile_20260718`
  ADD PRIMARY KEY (`cp_id`),
  ADD KEY `cp_lead_id` (`cp_lead_id`),
  ADD KEY `cp_pancard` (`cp_pancard`),
  ADD KEY `cp_mobile` (`cp_mobile`),
...
--
-- Indexes for table `docs_20260710_02_15`
--
ALTER TABLE `docs_20260710_02_15`
  ADD PRIMARY KEY (`docs_id`),
  ADD KEY `docs_active` (`docs_active`,`docs_deleted`),
  ADD KEY `pancard` (`pancard`),
  ADD KEY `mobile` (`mobile`),
...
ALTER TABLE `leads`
  ...
  ADD KEY `lead_closure_assign_user_id` (`lead_closure_assign_user_id`),
  ADD KEY `lead_credit_assign_datetime` (`lead_credit_assign_datetime`),
  ADD KEY `lead_screener_assign_datetime` (`lead_screener_assign_datetime`),
  ADD KEY `lead_credithead_assign_datetime` (`lead_credithead_assign_datetime`),
  ADD KEY `lead_collection_executive_assign_user_id` (`lead_collection_executive_assign_user_id`),
  ADD KEY `lead_credit_approve_user_id` (`lead_credit_approve_user_id`),
  ADD KEY `lead_collection_executive_assign_datetime` (`lead_collection_executive_assign_datetime`),
  ADD KEY `lead_final_disbursed_date` (`lead_final_disbursed_date`),
  ADD KEY `lead_journey_stage_id` (`lead_journey_stage_id`),
  ADD KEY `lead_disbursal_recommend_datetime` (`lead_disbursal_recommend_datetime`),
  ADD KEY `monthly_salary_amount` (`monthly_salary_amount`),
  ADD KEY `idx_status_user_created` (`lead_status_id`,`user_type`,`created_on`);

--
-- Indexes for table `leads_20260623`
--
ALTER TABLE `leads_20260623`
  ADD PRIMARY KEY (`lead_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `stage` (`stage`),
  ADD KEY `status` (`status`),
...
--
-- Indexes for table `leads_20260625`
--
ALTER TABLE `leads_20260625`
  ADD PRIMARY KEY (`lead_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `stage` (`stage`),
  ADD KEY `status` (`status`),
...
--
-- Indexes for table `leads_20260630`
--
ALTER TABLE `leads_20260630`
  ADD PRIMARY KEY (`lead_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `stage` (`stage`),
  ADD KEY `status` (`status`),
...
--
-- Indexes for table `leads_20260710_04_40`
--
ALTER TABLE `leads_20260710_04_40`
  ADD PRIMARY KEY (`lead_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `stage` (`stage`),
  ADD KEY `status` (`status`),
...
--
-- Indexes for table `leads_20260818`
--
ALTER TABLE `leads_20260818`
  ADD PRIMARY KEY (`lead_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `stage` (`stage`),
  ADD KEY `status` (`status`),
...
ALTER TABLE `leads_otp_trans`
  ...
  ADD KEY `lot_mobile_otp` (`lot_mobile_otp`,`lot_otp_verify_flag`);
...
ALTER TABLE `lead_customer`
  ...
  ADD KEY `pancard` (`pancard`),
  ADD KEY `aa_current_state_id` (`aa_current_state_id`),
  ADD KEY `aa_current_city_id` (`aa_current_city_id`),
  ADD KEY `state_id` (`state_id`),
  ADD KEY `city_id` (`city_id`),
  ADD KEY `customer_religion_id` (`customer_religion_id`),
  ADD KEY `customer_digital_ekyc_flag` (`customer_digital_ekyc_flag`),
  ADD KEY `pancard_verified_status` (`pancard_verified_status`),
  ADD KEY `email_verified_status` (`email_verified_status`),
  ADD KEY `customer_docs_available` (`customer_docs_available`),
  ADD KEY `customer_bre_run_flag` (`customer_bre_run_flag`),
  ADD KEY `customer_vkyc_flag` (`customer_vkyc_flag`),
  ADD KEY `customer_domain_flag` (`customer_domain_flag`),
  ADD KEY `customer_uan_flag` (`customer_uan_flag`),
  ADD KEY `customer_enach_flag` (`customer_enach_flag`);

--
-- Indexes for table `lead_customer_202260718`
--
ALTER TABLE `lead_customer_202260718`
  ADD PRIMARY KEY (`customer_seq_id`),
  ADD UNIQUE KEY `customer_lead_id` (`customer_lead_id`),
  ADD KEY `pancard` (`pancard`),
  ADD KEY `aa_current_state_id` (`aa_current_state_id`),
...
ALTER TABLE `lead_journey_events`
  ...
  ADD KEY `lje_lead_id` (`lje_lead_id`),
  ADD KEY `lje_profile_id` (`lje_profile_id`,`lje_journey_type_id`,`lje_ekyc`),
  ADD KEY `lje_otp_verify` (`lje_otp_verify`),
  ADD KEY `lje_resend_otp` (`lje_resend_otp`),
  ADD KEY `lje_login` (`lje_login`);
...
--
-- Indexes for table `loan_20260626`
--
ALTER TABLE `loan_20260626`
  ADD PRIMARY KEY (`loan_id`),
  ADD UNIQUE KEY `lead_id_2` (`lead_id`),
  ADD UNIQUE KEY `loan_no_2` (`loan_no`),
  ADD KEY `company_id` (`company_id`,`product_id`),
...
--
-- Indexes for table `loan_20260718`
--
ALTER TABLE `loan_20260718`
  ADD PRIMARY KEY (`loan_id`),
  ADD UNIQUE KEY `lead_id_2` (`lead_id`),
  ADD UNIQUE KEY `loan_no_2` (`loan_no`),
  ADD KEY `company_id` (`company_id`,`product_id`),
...
--
-- Indexes for table `loan_20260722`
--
ALTER TABLE `loan_20260722`
  ADD PRIMARY KEY (`loan_id`),
  ADD UNIQUE KEY `lead_id_2` (`lead_id`),
  ADD UNIQUE KEY `loan_no_2` (`loan_no`),
  ADD KEY `company_id` (`company_id`,`product_id`),
...
--
-- Indexes for table `loan_collection_visit`
--
ALTER TABLE `loan_collection_visit`
  ADD PRIMARY KEY (`col_visit_id`),
  ADD KEY `col_lead_id` (`col_lead_id`),
  ADD KEY `col_visit_scm_id` (`col_visit_scm_id`),
  ADD KEY `col_visit_field_status_id` (`col_visit_field_status_id`),
  ADD KEY `col_visit_allocated_to` (`col_visit_allocated_to`),
  ADD KEY `col_visit_requested_by` (`col_visit_requested_by`),
  ADD KEY `col_fe_visit_trip_status_id` (`col_fe_visit_trip_status_id`),
  ADD KEY `col_fe_visit_approval_user_id` (`col_fe_visit_approval_user_id`),
  ADD KEY `col_visit_address_type` (`col_visit_address_type`);
...
--
-- Indexes for table `master_city_20260617`
--
ALTER TABLE `master_city_20260617`
  ADD PRIMARY KEY (`m_city_id`),
  ADD KEY `m_city_active` (`m_city_active`,`m_city_deleted`),
  ADD KEY `m_city_name` (`m_city_name`),
  ADD KEY `m_city_state_id` (`m_city_state_id`),
...
ALTER TABLE `master_pincode`
  ...
  ADD UNIQUE KEY `m_pincode_value_2` (`m_pincode_value`,`m_pincode_city_id`),
...
--
-- Indexes for table `master_pincode_20260617`
--
ALTER TABLE `master_pincode_20260617`
  ADD PRIMARY KEY (`m_pincode_id`),
  ADD KEY `m_pincode_active` (`m_pincode_active`,`m_pincode_deleted`),
  ADD KEY `m_pincode_value` (`m_pincode_value`),
  ADD KEY `m_pincode_city_id` (`m_pincode_city_id`);
...
--
-- Indexes for table `master_pincode_old`
--
ALTER TABLE `master_pincode_old`
  ADD PRIMARY KEY (`m_pincode_id`),
  ADD KEY `m_pincode_active` (`m_pincode_active`,`m_pincode_deleted`),
  ADD KEY `m_pincode_value` (`m_pincode_value`),
  ADD KEY `m_pincode_city_id` (`m_pincode_city_id`);
...
--
-- Indexes for table `master_state_20260617`
--
ALTER TABLE `master_state_20260617`
  ADD PRIMARY KEY (`m_state_id`),
  ADD KEY `m_state_active` (`m_state_active`,`m_state_deleted`),
  ADD KEY `m_state_name` (`m_state_name`);
...
ALTER TABLE `tbl_verification`
  ...
  ADD KEY `lead_id` (`lead_id`),
  ADD KEY `init_residence_cpv` (`init_residence_cpv`),
  ADD KEY `init_office_cpv` (`init_office_cpv`);
...
--
ALTER TABLE `api_banking_cart_log`
  MODIFY `cart_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_bank_account_verification_logs`
--
ALTER TABLE `api_bank_account_verification_logs`
  MODIFY `bav_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_callback_trackier`
--
ALTER TABLE `api_callback_trackier`
...
--
ALTER TABLE `api_callback_upi`
  MODIFY `acu_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `api_disburse_logs`
  MODIFY `disburse_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_domain_verification_logs`
--
ALTER TABLE `api_domain_verification_logs`
  MODIFY `dv_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_ekyc_logs`
--
ALTER TABLE `api_ekyc_logs`
  MODIFY `ekyc_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_email_logs`
--
ALTER TABLE `api_email_logs`
  MODIFY `email_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `api_esign_logs`
  MODIFY `esign_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_face_match_logs`
--
ALTER TABLE `api_face_match_logs`
  MODIFY `fm_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_poi_verification_logs`
--
ALTER TABLE `api_poi_verification_logs`
  MODIFY `poi_veri_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_repayment_logs`
--
ALTER TABLE `api_repayment_logs`
  MODIFY `repayment_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_reverse_geo_code`
--
ALTER TABLE `api_reverse_geo_code`
  MODIFY `rg_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `api_threshold_logs`
--
ALTER TABLE `api_threshold_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_trackier_push_events`
--
ALTER TABLE `api_trackier_push_events`
  MODIFY `atpe_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_uan_logs`
--
ALTER TABLE `api_uan_logs`
...
--
ALTER TABLE `api_upi_logs`
  MODIFY `au_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_video_ekyc_logs`
--
ALTER TABLE `api_video_ekyc_logs`
  MODIFY `avedl_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `api_whatsapp_logs`
--
ALTER TABLE `api_whatsapp_logs`
  MODIFY `msg_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cif_customer`
  MODIFY `cif_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `collection_20260718`
--
ALTER TABLE `collection_20260718`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `collection_20260722`
--
ALTER TABLE `collection_20260722`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `collection_bucket_wise_permission`
  MODIFY `cbwp_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `credit_analysis_memo`
  MODIFY `cam_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `credit_analysis_memo_20260618`
--
ALTER TABLE `credit_analysis_memo_20260618`
  MODIFY `cam_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cron_scheduler_logs`
  MODIFY `cs_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customer_profile`
  MODIFY `cp_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `customer_profile_20260718`
--
ALTER TABLE `customer_profile_20260718`
  MODIFY `cp_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `docs`
  MODIFY `docs_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `docs_20260710_02_15`
--
ALTER TABLE `docs_20260710_02_15`
  MODIFY `docs_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `docs_master`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'DOCS ID';

--
-- AUTO_INCREMENT for table `export_access_logs`
--
ALTER TABLE `export_access_logs`
  MODIFY `eal_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `leads`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leads_20260623`
--
ALTER TABLE `leads_20260623`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leads_20260625`
--
ALTER TABLE `leads_20260625`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leads_20260630`
--
ALTER TABLE `leads_20260630`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leads_20260710_04_40`
--
ALTER TABLE `leads_20260710_04_40`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `leads_20260818`
--
ALTER TABLE `leads_20260818`
  MODIFY `lead_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `lead_bre_rule_result`
  MODIFY `lbrr_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lead_customer`
--
ALTER TABLE `lead_customer`
  MODIFY `customer_seq_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lead_customer_202260718`
--
ALTER TABLE `lead_customer_202260718`
  MODIFY `customer_seq_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `lead_customer_references`
  MODIFY `lcr_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lead_disbursement_trans_log`
--
ALTER TABLE `lead_disbursement_trans_log`
  MODIFY `disb_trans_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lead_eligibility_rules_result`
--
ALTER TABLE `lead_eligibility_rules_result`
  MODIFY `lerr_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `lead_journey_events`
  MODIFY `lje_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lead_rejection_reasons`
--
ALTER TABLE `lead_rejection_reasons`
  MODIFY `lrr_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `legal_email_logs`
  MODIFY `legal_email_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `loan_20260626`
--
ALTER TABLE `loan_20260626`
  MODIFY `loan_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `loan_20260718`
--
ALTER TABLE `loan_20260718`
  MODIFY `loan_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `loan_20260722`
--
ALTER TABLE `loan_20260722`
  MODIFY `loan_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `loan_collection_followup`
  MODIFY `lcf_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `loan_collection_visit`
--
ALTER TABLE `loan_collection_visit`
  MODIFY `col_visit_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_bank_account_status`
  MODIFY `bas_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_bank_type`
--
ALTER TABLE `master_bank_type`
  MODIFY `m_bank_type_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_blacklist_reject_reason`
--
ALTER TABLE `master_blacklist_reject_reason`
  MODIFY `m_br_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_branch`
--
ALTER TABLE `master_branch`
  MODIFY `m_branch_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_bre_rule`
--
ALTER TABLE `master_bre_rule`
  MODIFY `m_bre_rule_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_city`
--
ALTER TABLE `master_city`
  MODIFY `m_city_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_city_20260617`
--
ALTER TABLE `master_city_20260617`
  MODIFY `m_city_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_company_type`
  MODIFY `m_company_type_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_data_source`
  MODIFY `data_source_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_department`
--
ALTER TABLE `master_department`
  MODIFY `department_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_designation`
--
ALTER TABLE `master_designation`
  MODIFY `m_designation_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_disbursement_banks`
--
ALTER TABLE `master_disbursement_banks`
  MODIFY `disb_bank_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_electrical_provider`
--
ALTER TABLE `master_electrical_provider`
  MODIFY `electrical_pro_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_enduse`
--
ALTER TABLE `master_enduse`
  MODIFY `enduse_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_export`
--
ALTER TABLE `master_export`
  MODIFY `m_export_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_feedback_answers`
--
ALTER TABLE `master_feedback_answers`
  MODIFY `mfa_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_feedback_questions`
--
ALTER TABLE `master_feedback_questions`
  MODIFY `mfq_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_followup_status`
--
ALTER TABLE `master_followup_status`
  MODIFY `m_followup_status_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_followup_type`
--
ALTER TABLE `master_followup_type`
  MODIFY `m_followup_type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_industry`
--
ALTER TABLE `master_industry`
  MODIFY `m_industry_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_journey_stage`
--
ALTER TABLE `master_journey_stage`
  MODIFY `m_journey_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_marital_status`
  MODIFY `m_marital_status_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_marketing_channel`
--
ALTER TABLE `master_marketing_channel`
  MODIFY `mmc_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_mis_report`
--
ALTER TABLE `master_mis_report`
  MODIFY `m_report_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_occupation`
--
ALTER TABLE `master_occupation`
  MODIFY `m_occupation_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_payment_mode`
--
ALTER TABLE `master_payment_mode`
  MODIFY `mpm_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_pincode`
--
ALTER TABLE `master_pincode`
  MODIFY `m_pincode_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_pincode_20260617`
--
ALTER TABLE `master_pincode_20260617`
  MODIFY `m_pincode_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_pincode_old`
--
ALTER TABLE `master_pincode_old`
  MODIFY `m_pincode_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_qualification`
  MODIFY `m_qualification_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_relation_type`
--
ALTER TABLE `master_relation_type`
  MODIFY `mrt_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_residence_type`
--
ALTER TABLE `master_residence_type`
  MODIFY `m_residence_type_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_role_type`
--
ALTER TABLE `master_role_type`
  MODIFY `role_type_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_salary_mode`
  MODIFY `m_salary_mode_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `master_sms_template`
  MODIFY `m_st_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_state`
--
ALTER TABLE `master_state`
  MODIFY `m_state_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `master_state_20260617`
--
ALTER TABLE `master_state_20260617`
  MODIFY `m_state_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mis_access_logs`
  MODIFY `mal_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mobileapp_login_trans`
--
ALTER TABLE `mobileapp_login_trans`
  MODIFY `mlt_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_cibil`
  MODIFY `cibil_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_verification`
  MODIFY `verify_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_activity_log`
  MODIFY `ual_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_export_permission`
--
ALTER TABLE `user_export_permission`
  MODIFY `export_permission_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_mis_permission`
  MODIFY `mis_permission_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
