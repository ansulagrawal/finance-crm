  ...
  return (
    <>
      <div className='flex items-center justify-between'>
        <div>
          <h1 className='font-semibold text-2xl text-primary'>Audit queue</h1>
      ...
      <div
        className='flex flex-wrap items-center gap-2 rounded-lg border border-border bg-background p-4'
