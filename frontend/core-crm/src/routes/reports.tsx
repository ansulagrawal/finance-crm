  ...
  return (
    ...
    >
      <div className='flex items-start justify-between gap-4'>
        <div>
          <h2 className='font-semibold text-lg text-primary'>{def.label}</h2>
...
function ReportPicker({
  ...
  return (
    <div className='flex w-80 shrink-0 flex-col gap-3'>
      ...
      <div
        className='flex max-h-[70vh] flex-col divide-y divide-border/60 overflow-y-auto rounded-lg border border-border bg-background'
        style={{ boxShadow: 'var(--shadow-card)' }}
      >
        {filtered.length === 0 ? (
...
function ReportsPage() {
  ...
  return (
    <>
      <div>
        <h1 className='font-semibold text-2xl text-primary'>MIS Reports</h1>
