...
export function NumberInput({
  ...
  return (
    <div
      className={cn(
        'flex h-10 w-full items-stretch overflow-hidden rounded-md border border-border bg-background focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2',
        className,
      )}
    >
      <button
