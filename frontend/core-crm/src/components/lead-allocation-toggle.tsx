...
/**
 * Ports `LoginController::leadAllocation()` — the daily "I'm active today,
 * fresh or repeat cases" self-declaration a CR1/CR2 user makes from their
 * profile page in legacy (`profile.php`'s `#insert_lead_allocation` form).
 * Surfaced in the header here instead of a dedicated profile page (this
 * frontend doesn't have one yet) so a screener/credit-manager sees it every
 * day without having to navigate anywhere.
 */
