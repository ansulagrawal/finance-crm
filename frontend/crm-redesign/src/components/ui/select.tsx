...
export function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      className={cn(
        'px-3 py-1.5 font-display font-medium text-foreground/60 text-xs uppercase tracking-wide',
        className,
      )}
      {...props}
    />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          'z-50 min-w-32 overflow-hidden rounded-md border border-border bg-white shadow-lg',
          className,
        )}
        position='popper'
        sideOffset={4}
