...
function LeadBasicsStep({ onCreated }: { onCreated: (lead: Lead) => void }) {
  ...
  // Duplicate-lead detection: a soft warning here, not a hard block — same
  // architecture as legacy, whose intake form doesn't block either; the
  // real enforcement is server-side (LeadEligibilityService), right after
  // creation.
